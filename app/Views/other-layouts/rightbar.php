...
<div class="offcanvas offcanvas-end settings-panel border-0" id="settings-offcanvas" tabindex="-1" aria-labelledby="settings-offcanvas">
	<div class="offcanvas-header settings-panel-header bg-shape">
		...
		<div class="d-flex justify-content-between">
			<div class="d-flex align-items-start"><img class="me-2" src="<?php echo site_url(); ?>template-assets/img/icons/left-arrow-from-left.svg" width="20" alt="" />
				<div class="flex-1">
					...
					<p class="fs--1 mb-0">Switch your language direction </p><a class="fs--1" href="<?php echo site_url(); ?>/template-assets/documentation/customization/configuration.html">RTL Documentation</a>
					</div>
				</div>
		...
		<div class="d-flex justify-content-between">
			<div class="d-flex align-items-start"><img class="me-2" src="<?php echo site_url(); ?>template-assets/img/icons/arrows-h.svg" width="20" alt="" />
				<div class="flex-1">
						...
						<p class="fs--1 mb-0">Toggle container layout system </p><a class="fs--1" href="<?php echo site_url(); ?>/template-assets/documentation/customization/configuration.html">Fluid Documentation</a>
					</div>
				</div>
				<div class="form-check form-switch">
				...
				<div class="form-check form-check-inline">
					<input class="form-check-input" id="option-navbar-vertical" type="radio" name="navbar" value="vertical" data-page-url="<?php echo site_url(); ?>/template-assets/modules/components/nav-and-tabs/vertical-navbar.html" data-theme-control="navbarPosition" />
					<label class="form-check-label" for="option-navbar-vertical">Vertical</label>
				</div>
					<div class="form-check form-check-inline">
					<input class="form-check-input" id="option-navbar-top" type="radio" name="navbar" value="top" data-page-url="<?php echo site_url(); ?>/template-assets/modules/components/nav-and-tabs/top-navbar.html" data-theme-control="navbarPosition" />
					<label class="form-check-label" for="option-navbar-top">Top</label>
				</div>
					<div class="form-check form-check-inline me-0">
					<input class="form-check-input" id="option-navbar-combo" type="radio" name="navbar" value="combo" data-page-url="<?php echo site_url(); ?>/template-assets/modules/components/nav-and-tabs/combo-navbar.html" data-theme-control="navbarPosition" />
		...
		<div class="btn-group d-block w-100 btn-group-navbar-style">
			...
			<div class="text-center mt-5"><img class="mb-1" src="<?php echo site_url(); ?>template-assets/img/icons/spot-illustrations/47.png" alt="" width="120" />
				<h5>Like What You See?</h5>
				<p class="fs--1">Get Falcon now and create beautiful dashboards with hundreds of widgets.</p><a class="mb-1 btn btn-primary" href="https://themes.getbootstrap.com/product/falcon-admin-dashboard-webapp-template/" target="_blank">Purchase</a>
			</div>
		</div>
	</div>
