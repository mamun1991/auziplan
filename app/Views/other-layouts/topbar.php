...
<a class="navbar-brand me-1 me-sm-3" href="../../index.html">
                  ...
                  <img class="me-2" src="<?php echo site_url(); ?>custom-assets/images/logo_transparent.png" alt="Logo" width="40" />     
                      ...
                      <h5 class="pt-3" style="background-color: rgba(13, 110, 253, 0.00);color:rgba(0,0,0,1.0);padding-top: 0%; font-size:0px;font-weight:thin;text-align:center">
										    ...
										    <span style="color:rgba(55, 255, 255, 1.0);font-size:30px;font-weight:100; margin-right: 0px; margin-top: 10px;float: center;">Auzi</span>
										    <span style="color:rgba(13, 110, 252, 1.0);font-size:30px; margin-top: 10px;float: center;">Plan</span><span class="text-info fw-medium">CRM</span>
											</h5>
              ...
              <li class="nav-item dropdown">
                ...
                <div class="dropdown-menu dropdown-menu-end py-0" aria-labelledby="navbarDropdownUser">
                  <div class="bg-white dark__bg-1000 rounded-2 py-2">
                    ...
                    <h6 href="#"><?php echo $user->f_name . ' ' . $user->l_name ?></h6>

                
                  <a class="dropdown-item" href="#!" > 
                
                    <div class="d-flex align-items-center"><span class="fas fa-circle fa-1x text-info" aria-hidden="true"></span><span class="nav-link-text ps-3">Online</span>
                    </div>             
                  </a>
                ...
                <div class="d-flex align-items-center"><span class="fas fa-user fa-1x text-success" aria-hidden="true"></span><span class="nav-link-text ps-3">Administer</span>
                    </div>             
                  </a>
                  ...
                  <a class="dropdown-item" href="<?php echo site_url(); ?>user/changepassword"  role="button" aria-expanded="false">
                    <div class="d-flex align-items-center"><span class="fas fa-key fa-1x text-warning" aria-hidden="true"></span><span class="nav-link-text ps-3">Change Password</span>
                    </div>                  
                  </a>

                  <a class="dropdown-item" href="<?php echo site_url(); ?>user/companysetup" role="button" aria-expanded="false">
                    <div class="d-flex align-items-center"><span class="fas fa-cogs fa-1x text-default" aria-hidden="true"></span><span class="nav-link-text ps-3">Company Setup</span>
                   </div>
                  </a>

                  <a class="dropdown-item" href="<?php echo site_url(); ?>user/logout" role="button" aria-expanded="false">      
                    <div class="d-flex align-items-center"><span class="fas fa-sign-out-alt fa-1x text-success" aria-hidden="true"></span><span class="nav-link-text ps-3">Logout</span>
                    </div>             
                  </a>
