                    ...
                    <div class="card theme-wizard mb-5">
                        <div class="card-header bg-light pt-3 pb-2">
                            <ul class="nav justify-content-between nav-wizard">
                                <li class="nav-item"><a class="nav-link active fw-semi-bold" href="#bootstrap-wizard-tab1" data-bs-toggle="tab" data-wizard-step="data-wizard-step"><span class="nav-item-circle-parent"><span class="nav-item-circle"><span class="fas fa-chart-bar"></span></span></span><span class="d-none d-md-block mt-1 fs--1">Product Revenue</span></a></li>
                                <li class="nav-item"><a class="nav-link fw-semi-bold" href="#bootstrap-wizard-tab2" data-bs-toggle="tab" data-wizard-step="data-wizard-step"><span class="nav-item-circle-parent"><span class="nav-item-circle"><span class="fas fa-truck"></span></span></span><span class="d-none d-md-block mt-1 fs--1">Service Revenue</span></a></li>
                                <li class="nav-item"><a class="nav-link fw-semi-bold" href="#bootstrap-wizard-tab3" data-bs-toggle="tab" data-wizard-step="data-wizard-step"><span class="nav-item-circle-parent"><span class="nav-item-circle"><span class="fas fa-globe"></span></span></span><span class="d-none d-md-block mt-1 fs--1">Online Revenue</span></a></li>
                        ...
                        <div class="card-body py-4">                       
                            ...
                            <?php echo view('revenue_streams/service_revenue.php'); ?>
                            <?php echo view('revenue_streams/online_revenue.php'); ?>      		
                        </div><!--/.card body-->	   
