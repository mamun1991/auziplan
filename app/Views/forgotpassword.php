...
<html lang="en-US" dir="ltr">
  ...
  <meta charset="utf-8">
    ...
    <!--    Document Title-->
    <!-- ===============================================-->
    <title>Forgot Password | &amp; Planning is the key to your success!</title>
        ...
        <script>
         ...
         <div class="row min-vh-100 bg-100">
            <div class="col-6 d-none d-lg-block position-relative">
                 <div class="bg-holder" style="background-image:url(<?php echo site_url(); ?>template-assets/img/illustrations/1.svg);">
            </div>
            <!--/.bg-holder-->
                 ...
                 <div class="card">
                  ...
                  <div class="card-body p-4 msgemail">
                    <div class="text-center"><img class="d-block mx-auto mb-4" src="<?php echo site_url(); ?>template-assets/img/icons/spot-illustrations/16.png" alt="Email" width="100">
                      ...
                      <p>An email has been sent to <strong><span id='useremail'></span></strong>. Please click on the included link to reset your password.
                      </p>
                    </div>
                  </div>

                  <div class="card-body p-4 fgtpwdform">
                    <div class="text-center">
                      <h4 class="mb-0"> Forgot your password?</h4><small>Enter your email and we'll send you a reset link.</small>
                      <div id="frm<?php echo $controller; ?>" class="mb-3 mt-4">
 
                          <!--<input class="form-control validate" type="email" placeholder="Email address" id='email' />-->
                        ...
                        <div class="mb-3"></div>
                        <button class="btn btn-primary d-block w-100 mt-3 forgotpwd" type="button" name="submit">Send reset link</button>
                       </div> <!-- end frm -->
