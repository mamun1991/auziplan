...
#accordion_se .panel-heading{
    padding:0;
    background: #fff;
}
#accordion_se .panel-title a{
    display: block;
    position: relative;
...
#accordion_se .panel-title a.collapsed{
    color:#808080;
    border-bottom:1px solid #d3d3d3;
    margin: 0;
}
#accordion_se .panel-title a i{
    color:#0064B2;
    position: absolute;
    top: 14px;
    left:25px;
}
#accordion_se .panel-title a:before,
#accordion_se .panel-title a.collapsed:before{
    content:"";
    position: absolute;
    bottom:-15px;
    left:36px;
...
#accordion_se .panel-title a.collapsed:hover{
    color: #0064B2;
}
#accordion_se .panel-title a:after,
#accordion_se .panel-title a.collapsed:after{
    content: "\f106";
...
<div class="container-fluid">
  <div class="row">
        ...
        <!-- Accordion Panel -starts -->
                  ...
                  <div class="panel-group" id="accordion_se" role="tablist" aria-multiselectable="true">
                     
                      <div class="panel panel-default">
                          <div class="panel-heading" role="tab" id="heading_se_one">
                              <h4 class="panel-title">
                                  <a role="button" data-toggle="collapse" data-parent="#accordion_se" href="#collapse_se_one" aria-expanded="true" aria-controls="collapse_se_one">
                                      Who are my Directors?
                                  </a>
                              </h4>
                          </div>
                          <div id="collapse_se_one" class="panel-collapse collapse in" role="tabpanel" aria-labelledby="heading_se_one">
                      ...
                      <div class="panel panel-default">
                          <div class="panel-heading" role="tab" id="heading_se_two">
                              <h4 class="panel-title">
                                  <a class="collapsed" role="button" data-toggle="collapse" data-parent="#accordion_se" href="#collapse_se_two" aria-expanded="false" aria-controls="collapse_se_two">
                                      Will I need an Investors? 
                                  </a>
                              </h4>
                          </div>
                          <div id="collapse_se_two" class="panel-collapse collapse" role="tabpanel" aria-labelledby="heading_se_two">
                              <div class="panel-body">
                      ...
                      <div class="panel panel-default">
                          <div class="panel-heading" role="tab" id="heading_se_three">
                              <h4 class="panel-title">
                                  <a class="collapsed" role="button" data-toggle="collapse" data-parent="#accordion_se" href="#collapse_se_three" aria-expanded="false" aria-controls="collapse_se_three">
                                      Will I be needing a Bank Loan to start my business? 
                                  </a>
                              </h4>
                          </div>
                          <div id="collapse_se_three" class="panel-collapse collapse" role="tabpanel" aria-labelledby="heading_se_three">
                              <div class="panel-body">
                      ...
                      <div class="panel panel-default">
                          <div class="panel-heading" role="tab" id="heading_se_four">
                              <h4 class="panel-title">
                                  <a class="collapsed" role="button" data-toggle="collapse" data-parent="#accordion_se" href="#collapse_se_four" aria-expanded="false" aria-controls="collapse_se_four">
                                      What are my Operating Expenses? 
                                  </a>
                              </h4>
                          </div>
                          <div id="collapse_se_four" class="panel-collapse collapse" role="tabpanel" aria-labelledby="heading_se_four">
                              <div class="panel-body">
                      ...
                      <div class="panel panel-default">
                          <div class="panel-heading" role="tab" id="heading_se_five">
                              <h4 class="panel-title">
                                  <a class="collapsed" role="button" data-toggle="collapse" data-parent="#accordion_se" href="#collapse_se_five" aria-expanded="false" aria-controls="collapse_se_five">
                                      What are my One-Time startup costs? 
                                  </a>
                              </h4>
                          </div>
                          <div id="collapse_se_five" class="panel-collapse collapse" role="tabpanel" aria-labelledby="heading_se_five">
                              <div class="panel-body">
