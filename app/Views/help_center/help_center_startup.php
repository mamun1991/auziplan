...
#accordion_s .panel-title a.collapsed{
    color:#808080;
    border-bottom:1px solid #d3d3d3;
    margin: 0;
}
#accordion_s.panel-title a i{
    color:#0064B2;
    position: absolute;
    top: 14px;
    left:25px;
...
#accordion_s .panel-title a.collapsed:hover{
    color: #0064B2;
}
#accordion_s .panel-title a:after,
#accordion_s .panel-title a.collapsed:after{
    content: "\f106";
 ...
 <div class="u-containProse">
  <section class="content animated " >
    <div class="container-fluid">
      <p><b>Startup:</b>It is more then likely that your company will need to employ people,Jake and his partner Bob plan to have a team of 3 sales reps, 1,factory manager, 
        ...
        <div class="row">
          <div class="col-md-offset-0 col-md-12 center-contents">
            <!-- Accordion Panel -starts -->
              <div class="panel-group" id="accordion_s" role="tablist" aria-multiselectable="true">                  
                <div class="panel panel-default">
                  <div class="panel-heading" role="tab" id="heading_s_one">
                    <h4 class="panel-title">
                      <a role="button" data-toggle="collapse" data-parent="#accordion_s" href="#collapse_pe_one" aria-expanded="true" aria-controls="collapse_s_one">
                          How do I add a Director?
                      </a>
                    </h4>
                  </div>
                    <div id="collapse_pe_one" class="panel-collapse collapse in" role="tabpanel" aria-labelledby="heading_s_one">
                      ...
                      <div class="panel panel-default">
                          <div class="panel-heading" role="tab" id="heading_s_two">
                              <h4 class="panel-title">
                                  <a class="collapsed" role="button" data-toggle="collapse" data-parent="#accordion_s" href="#collapse_s_two" aria-expanded="false" aria-controls="collapse_s_two">
                                      Will I need an Investors? 
                                  </a>
                              </h4>
                          </div>
                          <div id="collapse_s_two" class="panel-collapse collapse" role="tabpanel" aria-labelledby="heading_s_two">
                              <div class="panel-body">
                      ...
                      <div class="panel panel-default">
                          <div class="panel-heading" role="tab" id="heading_s_three">
                              <h4 class="panel-title">
                                  <a class="collapsed" role="button" data-toggle="collapse" data-parent="#accordion_s" href="#collapse_s_three" aria-expanded="false" aria-controls="collapse_s_three">
                                      Will I be needing a Bank Loan to start my business? 
                                  </a>
                              </h4>
                          </div>
                          <div id="collapse_s_three" class="panel-collapse collapse" role="tabpanel" aria-labelledby="heading_s_three">
                              <div class="panel-body">
                      ...
                      <div class="panel panel-default">
                          <div class="panel-heading" role="tab" id="heading_s_four">
                              <h4 class="panel-title">
                                  <a class="collapsed" role="button" data-toggle="collapse" data-parent="#accordion_s" href="#collapse_s_four" aria-expanded="false" aria-controls="collapse_s_four">
                                      What are my Operating Expenses? 
                                  </a>
                              </h4>
                          </div>
                          <div id="collapse_s_four" class="panel-collapse collapse" role="tabpanel" aria-labelledby="heading_s_four">
                              <div class="panel-body">
                      ...
                      <div class="panel panel-default">
                          <div class="panel-heading" role="tab" id="heading_s_five">
                              <h4 class="panel-title">
                                  <a class="collapsed" role="button" data-toggle="collapse" data-parent="#accordion_s" href="#collapse_s_five" aria-expanded="false" aria-controls="collapse_s_five">
                                      What are my One-Time startup costs? 
                                  </a>
                              </h4>
                          </div>
                          <div id="collapse_s_five" class="panel-collapse collapse" role="tabpanel" aria-labelledby="heading_s_five">
                              <div class="panel-body">
                                     
                                <div class="row">
                                  <div class="col-md-6">                                 
                                  <p><strong>One-Time Costs</strong> are the initial costs in starting up a new business that are not recurring on a monthly basis.These items could be 
                                  computers,office equipment, or property plant and equipment.
                                  </p>        
                                  <h1>For example:</h1>  
                                  <p>Jake and his partner Bob have leased a factory with office space to start their business,they understand that they will need to purchase
                                      office equipment such as a new computer, printer and office furniture.<br><br>They will also need to pay a security bond
                                      to install telephone lines, and the real estate agents have requested  a security bond of 4 months rent in advance.</p>
                                  <hr style="border-top: 3px solid #0064B2; background: transparent;">    
