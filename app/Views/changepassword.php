...
<html lang="en-US" dir="ltr">
  ...
  <body>
      ...
      <div class="container-fluid">
        ...
        <div class="row min-vh-100 bg-100">
          <div class="col-6 d-none d-lg-block position-relative">
               <div class="bg-holder" style="background-image:url(<?php echo site_url(); ?>template-assets/img/illustrations/5.png);">
            </div>
            <!--/.bg-holder-->
              ...
              <div class="col-lg-9 col-xl-8 col-xxl-6">
                ...
                <div class="card-header text-center p-5">
                  ...
                  <div class="card-body p-4">
                    <div class="text-center"><img class="d-block mx-auto mb-4" src="<?php echo site_url(); ?>template-assets/img/icons/spot-illustrations/45.png" alt="shield" width="100" />
                      <p>Password can easily be forgotten<br /></p>
                   </div>
                    <h3 class="text-center">Change password</h3>

                      <div class="mt-3" id="frmuser">
                      ...
                      <div class="row gx-2">
                        ...
                        <div class="form-floating mb-3">
                            <input type="password" name="newpwd" autocomplete="off" class="form-control validate" id="newpwd" placeholder="What is your new password?">
                            <label for="split-reset-password" class="text-muted">What is your new password?</label>
                          </div><!-- /.float form -->
                        ...
                        <div class="form-floating mb-3">
                            <input type="password" autocomplete="off" name="cnewpwd" class="form-control validate" id="cnewpwd" placeholder="Confirm your new password?">
                            <label for="split-reset-confirm-password" class="text-muted">Confirm your new password?</label>
                          </div><!-- /.float form -->
                        ...
                        <!--<div class="mb-3">
                          ...
                          <input class="form-control validate" type="password" id="newpwd" />
                        </div>
                        <div class="mb-3">
                          <label class="form-label" for="split-reset-confirm-password">Confirm Password</label>
                          <input class="form-control validate" type="password" id="cnewpwd" />
                        </div>-->



                      <button class="btn btn-primary d-block w-49 mt-3" type="button" id="btnchangepassword" style='float:left;'>Set password</button>
                      <a class="btn btn-primary d-block w-50 mt-3" href="<?php echo site_url(); ?>main-dashboard" style='float:right;'>Go Back</a>
    ...
    <script src="<?php echo site_url(); ?>custom-assets/user.js?version=<?php echo rand(11111,55555); ?>"></script>
