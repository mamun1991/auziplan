  ...
  <body>
    ...
    <main class="main" id="top">
      <div class="container" data-layout="container">
        ...
        <nav class="navbar navbar-dark navbar-vertical navbar-expand-xl">
          <script>
          ...
          <div class="d-flex align-items-center">
            <div class="toggle-icon-wrapper">
              ...
              <div class="d-flex align-items-center py-3"><img class="me-2" src="<?php echo site_url(); ?>template-assets/img/icons/spot-illustrations/falcon.png" alt="" width="40" /><span class="font-sans-serif">falcon</span>
              </div>
            </a>
          </div>
            ...
            <div class="navbar-vertical-content scrollbar">
              ...
              <div class="settings mb-3">
                <div class="card alert p-0 shadow-none" role="alert">
                  ...
                  <div class="card-body text-center"><img src="<?php echo site_url(); ?>template-assets/img/icons/spot-illustrations/navbar-vertical.png" alt="" width="80" />
        ...
        <div class="content">
          <nav class="navbar navbar-light navbar-glass navbar-top navbar-expand">
            ...
            <a class="navbar-brand me-1 me-sm-3" href="index.html">
              <div class="d-flex align-items-center"><img class="me-2" src="<?php echo site_url(); ?>template-assets/img/icons/spot-illustrations/falcon.png" alt="" width="40" /><span class="font-sans-serif">falcon</span>
              </div>
            </a>
                  ...
                  <div class="dropdown-menu border font-base start-0 mt-2 py-0 overflow-hidden w-100">
                    <div class="scrollbar list py-3" style="max-height: 24rem;">
                      ...
                      <h6 class="dropdown-header fw-medium text-uppercase px-card fs--2 pt-0 pb-2">Files</h6><a class="dropdown-item px-card py-2" href="#!">
                        <div class="d-flex align-items-center">
                          <div class="file-thumbnail me-2"><img class="border h-100 w-100 fit-cover rounded-3" src="<?php echo site_url(); ?>template-assets/img/products/3-thumb.png" alt="" /></div>
                          <div class="flex-1">
                      ...
                      <a class="dropdown-item px-card py-2" href="#!">
                        <div class="d-flex align-items-center">
                          <div class="file-thumbnail me-2"><img class="img-fluid" src="<?php echo site_url(); ?>template-assets/img/icons/zip.png" alt="" /></div>
                          <div class="flex-1">
                      ...
                      <h6 class="dropdown-header fw-medium text-uppercase px-card fs--2 pt-0 pb-2">Members</h6><a class="dropdown-item px-card py-2" href="pages/user/profile.html">
                        <div class="d-flex align-items-center">
                          <div class="avatar avatar-l status-online me-2">
                            <img class="rounded-circle" src="<?php echo site_url(); ?>template-assets/img/team/1.jpg" alt="" />
                      ...
                      <a class="dropdown-item px-card py-2" href="pages/user/profile.html">
                        <div class="d-flex align-items-center">
                          <div class="avatar avatar-l me-2">
                            <img class="rounded-circle" src="<?php echo site_url(); ?>template-assets/img/team/2.jpg" alt="" />
                      ...
                      <a class="dropdown-item px-card py-2" href="pages/user/profile.html">
                        <div class="d-flex align-items-center">
                          <div class="avatar avatar-l me-2">
                            <img class="rounded-circle" src="<?php echo site_url(); ?>template-assets/img/team/3.jpg" alt="" />
                      ...
                      <div class="list-group list-group-flush fw-normal fs--1">
                        ...
                        <div class="list-group-item">
                          <a class="notification notification-flush" href="#!">
                            <div class="notification-avatar">
                              <div class="avatar avatar-2xl me-3">
                                <img class="rounded-circle" src="<?php echo site_url(); ?>template-assets/img/icons/weather-sm.jpg" alt="" />
                          ...
                          <a class="border-bottom-0 notification-unread  notification notification-flush" href="#!">
                            <div class="notification-avatar">
                              <div class="avatar avatar-xl me-3">
                                <img class="rounded-circle" src="<?php echo site_url(); ?>template-assets/img/logos/oxford.png" alt="" />
                        ...
                        <div class="list-group-item">
                          <a class="border-bottom-0 notification notification-flush" href="#!">
                            <div class="notification-avatar">
                              <div class="avatar avatar-xl me-3">
                                <img class="rounded-circle" src="<?php echo site_url(); ?>template-assets/img/team/10.jpg" alt="" />
              ...
              <div class="card h-md-100">
                ...
                <div class="card-body pt-2">
                  <div class="row g-0 h-100 align-items-center">
                    <div class="col">
                      <div class="d-flex align-items-center"><img class="me-3" src="<?php echo site_url(); ?>template-assets/img/icons/weather-icon.png" alt="" height="60" />
                        <div>
                    ...
                    <table class="table table-dashboard mb-0 table-borderless fs--1 border-200">
                      ...
                      <tbody>
                        <tr class="border-bottom border-200">
                          <td>
                            <div class="d-flex align-items-center position-relative"><img class="rounded-1 border border-200" src="<?php echo site_url(); ?>template-assets/img/products/12.png" width="60" alt="" />
                        ...
                        <tr class="border-bottom border-200">
                          <td>
                            <div class="d-flex align-items-center position-relative"><img class="rounded-1 border border-200" src="<?php echo site_url(); ?>template-assets/img/products/10.png" width="60" alt="" />
                              <div class="flex-1 ms-3">
                        ...
                        <tr class="border-bottom border-200">
                          <td>
                            <div class="d-flex align-items-center position-relative"><img class="rounded-1 border border-200" src="<?php echo site_url(); ?>template-assets/img/products/11.png" width="60" alt="" />
                              <div class="flex-1 ms-3">
                        ...
                        <tr class="border-bottom border-200">
                          <td>
                            <div class="d-flex align-items-center position-relative"><img class="rounded-1 border border-200" src="<?php echo site_url(); ?>template-assets/img/products/14.png" width="60" alt="" />
                              <div class="flex-1 ms-3">
                        ...
                        <tr>
                          <td>
                            <div class="d-flex align-items-center position-relative"><img class="rounded-1 border border-200" src="<?php echo site_url(); ?>template-assets/img/products/13.png" width="60" alt="" />
                              <div class="flex-1 ms-3">
              ...
              <div class="card">
                ...
                <div class="card-body pb-0">
                  <div class="d-flex mb-3 hover-actions-trigger align-items-center">
                    <div class="file-thumbnail"><img class="border h-100 w-100 fit-cover rounded-2" src="<?php echo site_url(); ?>template-assets/img/products/5-thumb.png" alt="" />
                    </div>
                    <div class="ms-3 flex-shrink-1 flex-grow-1">
                      ...
                      <div class="hover-actions end-0 top-50 translate-middle-y"><a class="btn btn-light border-300 btn-sm me-1 text-600" data-bs-toggle="tooltip" data-bs-placement="top" title="Download" href="<?php echo site_url(); ?>template-assets/img/icons/cloud-download.svg" download="download"><img src="<?php echo site_url(); ?>template-assets/img/icons/cloud-download.svg" alt="" width="15" /></a>
                        <button class="btn btn-light border-300 btn-sm me-1 text-600 shadow-none" type="button" data-bs-toggle="tooltip" data-bs-placement="top" title="Edit"><img src="<?php echo site_url(); ?>template-assets/img/icons/edit-alt.svg" alt="" width="15" /></button>
                      </div>
                    </div>
                  </div>
                  <hr class="bg-200" />
                  <div class="d-flex mb-3 hover-actions-trigger align-items-center">
                    <div class="file-thumbnail"><img class="border h-100 w-100 fit-cover rounded-2" src="<?php echo site_url(); ?>template-assets/img/products/3-thumb.png" alt="" />
                    </div>
                    <div class="ms-3 flex-shrink-1 flex-grow-1">
                  ...
                  <hr class="bg-200" />
                  <div class="d-flex mb-3 hover-actions-trigger align-items-center">
                    <div class="file-thumbnail"><img class="img-fluid" src="<?php echo site_url(); ?>template-assets/img/icons/zip.png" alt="" />
                    </div>
                    <div class="ms-3 flex-shrink-1 flex-grow-1">
                  ...
                  <hr class="bg-200" />
                  <div class="d-flex mb-3 hover-actions-trigger align-items-center">
                    <div class="file-thumbnail"><img class="border h-100 w-100 fit-cover rounded-2" src="<?php echo site_url(); ?>template-assets/img/products/2-thumb.png" alt="" />
                    </div>
                    <div class="ms-3 flex-shrink-1 flex-grow-1">
                  ...
                  <hr class="bg-200" />
                  <div class="d-flex mb-3 hover-actions-trigger align-items-center">
                    <div class="file-thumbnail"><img class="img-fluid" src="<?php echo site_url(); ?>template-assets/img/icons/docs.png" alt="" />
                    </div>
                    <div class="ms-3 flex-shrink-1 flex-grow-1">
                ...
                <div class="card-body py-2">
                  ...
                  <div class="d-flex align-items-center position-relative mb-3">
                    <div class="avatar avatar-2xl status-offline">
                      <img class="rounded-circle" src="<?php echo site_url(); ?>template-assets/img/team/4.jpg" alt="" />
                  ...
                  <div class="d-flex align-items-center position-relative false">
                    <div class="avatar avatar-2xl status-offline">
                      <img class="rounded-circle" src="<?php echo site_url(); ?>template-assets/img/team/5.jpg" alt="" />
