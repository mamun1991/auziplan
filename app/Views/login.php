    ...
    <div class="container-fluid">
      ...
      <div class="row min-vh-100 bg-100">
        <div class="col-6 d-none d-lg-block position-relative">
          <div class="bg-holder" style="background-image:url(<?php echo site_url(); ?>template-assets/img/illustrations/2.svg);">
          </div>
          <!--/.bg-holder-->
              ...
              <div class="card">
                ...
                <div class="card-body p-4">
                  <div class="row flex-between-center">
                    ...
                    <div class="col-auto fs--1 text-600"><span class="mb-0 fw-semi-bold">New User?</span> <span><a href="<?php echo site_url() ?>register">Create account</a></span></div>
                  </div>
                  <!-- Form Control DIV -->
                  <div id="frm<?php echo $controller; ?>">

                    <div class="form-floating mb-3">
                      <input type="email" name="email" class="form-control validate" id="email" placeholder="What is your email address?">
                      <label for="split-login-email" class="text-muted">What is your email address?</label>
                    </div><!-- /.float form -->
                    <div class="form-floating mb-3">
                      <input type="password" name="password" class="form-control validate" id="password" placeholder="What is your password?" onkeypress="event.which == 13 ? document.getElementById('button-login').click() : true">
                      <label for="split-login-password" class="text-muted">What is your password?</label>
                    </div><!-- /.float form -->
                    ...
                    <div class="row flex-between-center">
                      ...
                      <div class="col-auto"><a class="fs--1" href="<?php echo site_url() . 'login/forgotpassword'; ?>">Forgot Password?</a></div>
                    </div>
                    <div class="mb-3">
                      <button class="btn btn-primary d-block w-100 mt-3 login" id="button-login" type="button" name="submit">Log in</button>
                    </div>
