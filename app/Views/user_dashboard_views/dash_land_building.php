			<div class="card text-left">
				<div class="card-header ">
					...
					<div class="row g-0">
						<div class="col-md-9">
							<h5 class="display-5">Land and Building</h5>
							<p>Will you be purchasing office or warehouse space <?php echo $user->f_name . ' ' . $user->l_name ?>?</p>
							<!--  <img src="<?= asset_url() ?>img/meet_jake/dashboard/d_4.png" width="60%" height="60%" class="img-fluid" alt="jake">-->
						</div><!-- /.card -->
						<div class="col-md-3">
							<div class="float-end ">
								<button type="button" class="btn btn-outline-primary" data-bs-toggle="modal" data-bs-target="#labuModal"><i class="fa fa-info-circle" aria-hidden="true"></i></button>
								<button class="btn btn-outline-success" type="button" onclick="add_onetimecost('land_buildings')" toogle="" id="btnOpenForm_onetime"><i class="fa fa-plus" aria-hidden="true"></i></button>
								<a href="<?php echo site_url(); ?>Startup#startupstep4" class="btn btn-outline-primary" onclick="setRadioOptions('land_buildings')"><i class="fa fa-arrow-right" aria-hidden="true"></i></a>
							</div><!-- /.float  -->
						</div><!-- /.col-->
					</div><!-- /.col-->
				</div>
					...
					<div class="row">
					    <div class="col-md-6 col-sm-12">
							<div class="card " style="height: 400px; width: 100%;">
								<div class="card-header ">
									<h4 class="my-0 font-weight-normal">Land Summary</h4>
								</div>
								<div class="card-body">
							...
							<div class="card " style="height: auto; width: 100%;">
								<div class="card-header ">
									<h4 class="my-0 font-weight-normal">Property Cost Summary</h4>
								</div>
								<div class="card-body">
									...
									<h1 class="card-title text-center text-primary fs-lg-1 m-2" id="landbuilding_dashboard_total"><?php echo $cur . ' ' . number_format($la_total, 0, '.', ','); ?></h1>
								</div>
							</div>
						</div>
					</div>
			...
			<div class="modal fade" id="labuModal" tabindex="-1" aria-labelledby="labuModalLabel" aria-hidden="true">
				<div class="modal-dialog modal-dialog-scrollable modal-xl">
					<div class="modal-content">
						...
						<div class="modal-body">
							<?php echo view('help_center/dashboard/dashboard_info/dashboard-land-building'); ?>
						</div>
