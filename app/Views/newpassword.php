...
==============================================================================*/
  ...
  <body>
      ...
      <div class="container-fluid">
        ...
        <div class="row min-vh-100 bg-100">
          <div class="col-6 d-none d-lg-block position-relative">
                 <div class="bg-holder" style="background-image:url(<?php echo site_url(); ?>template-assets/img/illustrations/6.png);">
            </div>
            <!--/.bg-holder-->
                    ...
                    <div class="row flex-between-center">
                     ...
                     <div id="frm<?php echo $controller; ?>">
                         ...
                         <div class="form-floating mb-3">
                            ...
                            <label for="split-login-email" class="text-muted">What is your new password?</label>
                          </div><!-- /.float form -->
                          ...
                          <!--<div class="mb-3">
                            <label class="form-label" for="split-login-email">New Password</label>
                            <input class="form-control validate" id="newpwd" type="password" />
                          </div>-->
                          ...
                          <div class="form-floating mb-3">
                            ...
                            <label for="split-login-password" class="text-muted">Confirm your new password?</label>
                          </div><!-- /.float form -->
                          ...
                          <!--<div class="mb-3">
                            <div class="d-flex justify-content-between">
                              <label class="form-label" for="split-login-password">Confirm New Password</label>
                            </div>
                            <input class="form-control validate" id="cnewpwd" type="password" />
                      ...
                      <div class="mb-3">
                          <input type='hidden' id='verify_code' value='<?php echo $verify_code; ?>'>
                        <button class="btn btn-primary d-block w-100 mt-3 newpassword" type="button" name="submit">Reset Password</button>
                      </div>
                      <!-- Form Control DIV END -->
                      </div>


                      <div class="col-auto float-end pt-3"><a class="fs--1" href="<?php echo site_url(); ?>">Back to AuziPlan</a></div>
                  </div>
                </div>
              </div>
            </div>
    ...
    <script src="<?php echo site_url(); ?>custom-assets/login.js?version=<?php echo rand(11111,55555); ?>"></script>
