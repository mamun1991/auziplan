            ...
            <div class="row justify-content-center g-0">
             ...
             <!-- <div class="card-header bg-circle-shape bg-shape text-center p-2"> -->
                  <div class="card-header text-center p-2">
										<h3 class="pt-3" style="background-color: rgba(13, 110, 253, 0.00);color:rgba(0,0,0,1.0);padding-top: 0%; font-size:0px;font-weight:thin;text-align:center">
										    <!--<span><img src='<?php echo site_url(); ?>custom-assets/images/logo_transparent.png' style='width: 60px; height: 60px; pb-4'/></span>-->
										    <span style="color:rgba(55, 255, 255, 1.0);font-size:70px;font-weight:100; margin-right: 0px; margin-top: 20px;float: center;">Auzi</span>
										    <span style="color:rgba(13, 110, 252, 1.0);font-size:70px; margin-top: 20px;float: center;">Plan</span>
											</h3>
                  </div>
                  ...
                  <div class="card-body p-4">
                    <div class="text-center"><img class="d-block mx-auto mb-4" src="<?php echo site_url(); ?>template-assets/img/icons/spot-illustrations/45.png" alt="shield" width="100" />
                      <h3>See you again!</h3>
                      <p>Thanks for using Auziplan. You have <br />now successfully signed out.</p><a class="btn btn-primary btn-sm mt-3" href="<?php echo site_url() ?>login"><span class="fas fa-chevron-left me-1" data-fa-transform="shrink-4 down-1"></span>Return to Login</a>
                    </div>
