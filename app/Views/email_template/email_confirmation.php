        ...
        <script>
         ...
         <div class="row min-vh-100 bg-100">
            <div class="col-6 d-none d-lg-block position-relative">
                 <div class="bg-holder" style="background-image:url(<?php echo site_url(); ?>template-assets/img/illustrations/3.svg);">
            </div>
            <!--/.bg-holder-->
              ...
              <div class="col-lg-9 col-xl-8 col-xxl-6">
                 <div class="card">
                    ...
                    <div class="card-body p-4">
                      ...
                      <p>
                          You have successfully registered your account with us.
                      </p>

                        <p >
                          Let's first active your account
                      </p>

                        <!--Button To Activate Account Starts-->
                                    
                        <a class="btn btn-falcon-success btn-lg mt-4 fs-0 py-2" href="<?php echo $confirmation_link; ?>">Activate to Start planning with AuziPlan<span class="fas fa-play ms-2" data-fa-transform="shrink-6 down-1"></span></a>
                              
                        </div> <!-- end frm -->
                  
                      <p class=" text-center pt-3">28 A Edward Street.Kingsgrove NSW 2208. Sydney, Australia.
                      <p class=" text-center pt-0">&copy; Copyright 2005-<script type="text/javascript">document.write(new Date().getFullYear());</script> AuziPlan Pty Ltd. All rights reserved</p>
