           ...
           <ul class="navbar-nav ms-auto">
             <?php
              if (!$session->has('user')) { ?>
                       ...
                       <div class="row">
                         <div class="col-6 col-md-5">
                           <div class="nav flex-column">
                             ...
                             <a class="dropdown-item" href="<?php echo site_url(); ?>about" role="button" aria-expanded="false">
                               <div class="d-flex align-items-center"><span class="nav-link-text ps-3">About</span>
                               </div>
                             </a>

                             <a class="dropdown-item" href="<?php echo site_url(); ?>gettingstarted" role="button" aria-expanded="false">
                               <div class="d-flex align-items-center"><span class="nav-link-text ps-3"> Getting Started</span>
                               </div>
                             </a>

                             <a class="dropdown-item" href="<?php echo site_url(); ?>pricing" role="button" aria-expanded="false">
                               <div class="d-flex align-items-center"><span class="nav-link-text ps-3">Pricing</span>
                               </div>
                             </a>

                             <a class="dropdown-item" href="<?php echo site_url(); ?>features" role="button" aria-expanded="false">
                               <div class="d-flex align-items-center"><span class="nav-link-text ps-3">Features</span>
                               </div>
                             </a>
                             <a class="dropdown-item" href="<?php echo site_url(); ?>privacy" role="button" aria-expanded="false">
                               <div class="d-flex align-items-center"><span class="nav-link-text ps-3">Legal Documents</span>
                               </div>
                             </a>

                             <a class="dropdown-item" href="<?php echo site_url(); ?>faq" role="button" aria-expanded="false">
               ...
               <li class="nav-item"><a class="nav-link" href="<?php echo site_url() . 'logout' ?>"><span class="d-none d-lg-inline-block" data-bs-toggle="tooltip" data-bs-placement="bottom" title="Feed"></span> Home</a></li>
