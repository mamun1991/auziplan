      ...
      <div class="container-fluid">
        <script>
         ...
         <div class="bg-holder d-none d-lg-block bg-card" style="background-image:url(<?php echo site_url(); ?>template-assets/img/icons/spot-illustrations/corner-5.png);"></div> <!--/.bg-holder-->
          <div class="col-sm-10 col-md-6 px-sm-0 align-self-center mx-auto py-0">
            <div class="card-body">
                      ...
                      <div class="border rounded-3 overflow-hidden mb-3 mb-md-0">
                        ...
                        <div class="p-4 bg-light">
                          <ul class="list-unstyled">
                            ...
                            <a href="<?php echo site_url().'plans/subscribe/yearly'; ?>" class="btn btn-outline-primary d-block w-100">
                                Purchase Plan
                            </a>
