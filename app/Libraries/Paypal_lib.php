...
class paypal_lib {
	...
	function __construct()
	{
		...
		$sanbox = TRUE;
		$business = 'inquiries-facilitator@excelplans.com.au';
		$paypal_lib_ipn_log_file = APPPATH . 'logs/paypal_ipn.log';
		...
		$this->ipn_log_file = $paypal_lib_ipn_log_file;
		$this->ipn_log = $paypal_lib_ipn_log; 
		
		$this->button_path = $paypal_lib_button_path;
		...
		$this->add_field('currency_code', $paypal_lib_currency_code);
