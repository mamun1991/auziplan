...
(function ($) {
	...
	$.fn.bootstrapWizard = function (options) {
		...
		if (typeof options == 'string') {
			...
			return this.data('bootstrapWizard');
		}
...
! function (t) {
	...
	t.expr[":"].notmdproc = function (o) {
		...
		init: function (o) {
			...
			var i = t(document);
			t.fn.ripples && this.options.ripples && this.ripples(), this.options.input && this.options.checkbox && this.checkbox(), this.options.togglebutton && this.togglebutton(), this.options.radio && this.radio(), this.options.autofill && (this.autofill(), this.attachAutofillEventHandlers()), document.arrive && this.options.arrive && (t.fn.ripples && this.options.ripples && i.arrive(this.options.withRipples, function () {
