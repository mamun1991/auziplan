                  ...
                  +"<table id='table-report-cash_1' class='table table-striped table-condensed'>"
                    ...
                    html += "</tr>"
                      ...
                      +"<tr class='info'>"
                          ...
                          if (data['colspan_rsvbl'] == "0"){
							for (i=1;i<=12;i++){
							   html += "<td width='6%' id='tot_receipt_<?php echo $i ;?>'>"+data['currency']+' '+number_format(data['tot_receipt_'+i],0,'.',',')+"</td>"
							}
                          }else{
                ...
                +"<div class='table-responsive'>"
                  ...
                  +"<table id='table-report-cash_7' class='table table-striped table-condensed'>"
                    ...
                    +"<tr>"
						...
						for ($i=1;$i<=12;$i++){
                            ...
                            +"<div class='form-group'>"
                              +"<input type='number' class='form-control inputfont' id='cp_<?php echo $i; ?>' name='cp_"+i+"' value='"+data['cp_'+i]+"' onchange='calculationSection8()'>"
                            +"</div>"
                        +"</td>"
						}
                    +"</tr>"
                    ...
                    +"<tr>"
                        ...
                        +"<td width='6%'>"
                            +"<div class='form-group'>"
                              +"<input type='number' class='form-control inputfont' id='dp_<?php echo $i; ?>' name='dp_<?php echo $i; ?>' value='"+data['dp_<?php echo $i; ?>']+"' onchange='calculationSection8()'>"
                            +"</div>"
                        +"</td>"
                        <?php } ?>
                    +"</tr>"
                    ...
                    +"<tr class='info'>"
                        ...
                        <?php for ($i=1;$i<=12;$i++){ ?>
                        +"<td width='6%' id='tot_capital_items_<?php echo $i; ?>'>"+data['currency']+" 0</td>"
                        <?php } ?>
                    +"</tr>"
                    +"<tr class='info'>"
                        +"<td width='16%'>Closing Cash Balance</td>"
                        <?php for ($i=1;$i<=12;$i++){ ?>
                        +"<td width='6%' id='closing_cash_balance_<?php echo $i; ?>'>"+data['currency']+" 0</td>"
                        <?php } ?>
                    +"</tr>"
                    +"</table>"
                    +"</form>"
            ...
            +"<div id='gstvst_collected' class='panel-collapse collapse'>"
                +"<div class='table-responsive'>"
                  ...
                  +"<table id='table-report-cash_8' class='table table-striped table-condensed'>"
                    ...
                    +"</thead>"
                    +"<tr class='success'>"
                        +"<td colspan='2'><strong> GST/VAT </strong></td>"
                        +"<td colspan='11'></td>"
                    +"</tr>"
                    +"<tr class='info'>"
                        +"<td width='16%'> GST/VAT Collected</td>"
                ...
                +"<div class='table-responsive'>"
                  +"<table id='table-report-monthly_0' class='table table-striped table-condensed'>"
                    ...
                    +"<tr>"
                        ...
                        <?php
                        for ($i=1;$i<=12;$i++){ ?>
                          +"<td width='6%'>"+data['currency']+' '+number_format(data['imported_spp_<?php echo $i; ?>'],0,'.',',')+"</td>"
                        <?php } ?>
                    +"</tr>"
                    +"<tr>"
                        ...
                        <?php
                        for ($i=1;$i<=12;$i++){ ?>
                          +"<td width='6%'>"+data['currency']+' '+number_format(data['product_spp_<?php echo $i; ?>'],0,'.',',')+"</td>"
                        <?php } ?>
                    +"</tr>"
                    +"<tr>"
                    ...
                    +"<tr class='info'>"
                        ...
                        <?php
                        for ($i=1;$i<=12;$i++){ ?>
                        +"<td width='6%'>"+data['currency']+' '+number_format(data['total_income_<?php echo $i; ?>'],0,'.',',')+"</td>"
                         <?php } ?>
                    +"</tr>"
                  +"</table>"
                +"</div>"
                ...
                +"<div class='table-responsive'>"
                  +"<table id='table-report-monthly_1' class='table table-striped table-condensed'>"
                    ...
                    +"<tr>"
                        ...
                        <?php
                        for ($i=1;$i<=12;$i++){ ?>
                        +"<td width='6%'>"+data['currency']+' '+number_format(data['imported_ssp_<?php echo $i;?>'],0,'.',',')+"</td>"
                        <?php } ?>
                      +"</tr>"
                    +"<tr>"
                        +"<td width='6%'>Products</td>"
                         <?php
                        for ($i=1;$i<=12;$i++){ ?>
                        +"<td width='6%'>"+data['currency']+' '+number_format(data['product_ssp_<?php echo $i;?>'],0,'.',',')+"</td>"
                        <?php } ?>
                      +"</tr>"
                    +"<tr>"
                        +"<td width='6%'>Services</td>"
                    ...
                    +"<tr class='info'>"
                        ...
                        <?php for ($i=1;$i<=12;$i++){ ?>
                        +"<td width='6%'>"+data['currency']+' '+number_format(data['total_income2_<?php echo $i; ?>'],0,'.',',')+"</td>"
                        <?php } ?>
                      +"</tr>"
                    +"<tr class='info'>"
                        +"<td width='6%'>% Cost Of Goods</td>"
                        <?php for ($i=1;$i<=12;$i++){ ?>
                        +"<td width='6%'>"+number_format(data['tot_income_percent_<?php echo $i; ?>'],2,'.',',')+" %</td>"
                        <?php } ?>
                      +"</tr>"
                  +"</table>"
                +"</div>"
              ...
              +"<div class='table-responsive'>"
                +"<table id='table-report-monthly_2' class='table table-striped table-condensed'>"
                  ...
                  +"<tr class='info'>"
                      ...
                      <?php for ($i=1;$i<=12;$i++){ ?>
                      +"<td width='6%'>"+data['currency']+' '+number_format(data['gross_profit_<?php echo $i; ?>'],0,'.',',')+"</td>"
                      <?php } ?>
                  +"</tr>"
                  +"<tr class='info'>"
                      +"<td width='6%'>% Gross Profit</td>"
                      <?php for ($i=1;$i<=12;$i++){ ?>
                      +"<td width='6%'>"+number_format(data['gross_profit_percent_<?php echo $i; ?>'],2,'.',',')+" %</td>"
                      <?php } ?>
                    +"</tr>"
                +"</table>"
              +"</div>"
              ...
              +"<div class='table-responsive'>"
                +"<table id='table-report-monthly_3' class='table table-striped table-condensed'>"
                  ...
                  +"<tr class='info'>"
                      ...
                      <?php for ($i=1;$i<=12;$i++){ ?>
                      +"<td width='6%'>"+number_format(data['oepercentmonth_<?php echo $i; ?>'],2,'.',',')+" %</td>"
                      <?php } ?>
                    +"</tr>"
                +"</table>"
              +"</div>"
              ...
              +"<div class='table-responsive'>"
                +"<table id='table-report-monthly_6' class='table table-striped table-condensed'>"
                  ...
                  +"<tr class='info'>"
                      ...
                      <?php for ($i=1;$i<=12;$i++){ ?>
                      +"<td width='6%'>"+data['currency']+' '+number_format(data['pretax_profit_month_<?php echo $i; ?>'],0,'.',',')+"</td>"
                      <?php } ?>
                  +"</tr>"
                  +"<tr class='info'>"
              ...
              +"<div class='table-responsive'>"
                +"<table id='table-report-monthly_7' class='table table-striped table-condensed'>"
                  ...
                  +"<tr>"
                      ...
                      <?php for ($i=1;$i<=12;$i++){ ?>
                      +"<td width='6%'>"+data['currency']+' '+number_format(data['comptax_month_<?php echo $i; ?>'],0,'.',',')+"</td>"
                      <?php } ?>
                  +"</tr>"
                  +"<tr>"
                      +"<td width='6%'>Net Profit</td>"
                      <?php for ($i=1;$i<=12;$i++){ ?>
                      +"<td width='6%'>"+data['currency']+' '+number_format(data['net_profit_month_<?php echo $i; ?>'],0,'.',',')+"</td>"
                      <?php } ?>
                  +"</tr>"
                  +"<tr>"
                      +"<td colspan='13'>&nbsp;</td>"
              ...
              +"<div class='table-responsive'>"
                +"<table id='table-report-monthly_8'  class='table table-striped table-condensed'>"
                  ...
                  +"<tr class='info'>"
                      +"<td width='6%'>&nbsp;</td>"
                      <?php for ($i=1;$i<=12;$i++){ ?>
                          +"<td width='6%'>"+data['currency']+' '+number_format(data['accumulatedgrossprofit_month_<?php echo $i; ?>'],0,'.',',')+"</td>"
                      <?php } ?>
                  +"</tr>"
                +"</table>"
              +"</div>"
