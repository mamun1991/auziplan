   ...
   // toolbar2: "print preview media | forecolor backcolor emoticons",
    ...
    setup: function (ed) {
        ...
        ed.on('KeyDown', function (e) {
            ...
            $("#mission-limit").html(text_content.length + " / " + 500000);
            if (text_content.length > 490000) {
                if (e.keyCode !== 8) {
                    alert('You can only enter maximum 500000 characters in this section .');
                    e.preventDefault();
                    e.stopPropagation();
                    return false;
                } else {
    ...
    setup: function (ed) {
        ...
        ed.on('KeyDown', function (e) {
            ...
            if (text_content.length > 299) {
                if (e.keyCode != 8) {
                    alert('You can enter maximum 300 character in this section.');
                    e.preventDefault();
                    e.stopPropagation();
                    return false;
                } else {
    ...
    setup: function (ed) {
        ...
        ed.on('KeyDown', function (e) {
            ...
            if (text_content.length > 1699) {
                if (e.keyCode != 8) {
                    alert('You can enter maximum 1700 character in this section.');
                    e.preventDefault();
                    e.stopPropagation();
                    return false;
                } else {
...
tinymce.init({
    ...
    setup: function (ed) {
        ...
        ed.on('KeyDown', function (e) {
            var text_content = $(ed.getBody()).text();
            $("#executive-limit").html(text_content.length + " / " + 200000000);
